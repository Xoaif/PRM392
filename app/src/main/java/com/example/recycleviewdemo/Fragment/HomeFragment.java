...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View homeProduct = inflater.inflate(R.layout.fragment_home, container, false);

        mProduct = getListProduct();
        rcvData = homeProduct.findViewById(R.id.rcv_data);
        rcvData.setLayoutManager(new LinearLayoutManager(getActivity()));
        productAdapter = new ProductAdapter(mProduct, new IClickItemProductListener() {
            @Override
